...
<div class="auth-box">
    ...
    <form action="../Controller/register.php" method="post">
        ...
        <input type="text" name="student_id" value="<?php echo ($studentId); ?>" placeholder="22-46183-1" required>
        <label>Full Name</label>
        <input type="text" name="name" value="<?php echo ($name); ?>" required>
        <label>AIUB Email</label>
        <input type="email" name="email" value="<?php echo ($email); ?>" placeholder="you@example.com" required>
